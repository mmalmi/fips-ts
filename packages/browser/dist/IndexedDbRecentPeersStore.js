import { createRecentPeers, parseRecentPeers, } from "@fips/core";
 ...
 */
export class IndexedDbRecentPeersStore {
    dbName;
    constructor(dbName = DEFAULT_RECENT_PEERS_DB_NAME) {
        this.dbName = dbName;
    }
    async load(localNpub, scope) {
    ...
    async save(recentPeers) {
        const validated = parseRecentPeers(recentPeers, recentPeers.local_npub, recentPeers.scope);
        const db = await this.openDb();
        try {
...
//# sourceMappingURL=IndexedDbRecentPeersStore.js.map