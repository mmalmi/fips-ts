...
Browser TypeScript implementation of [FIPS](https://github.com/jmcorgan/fips) — node identity, FMP / FSP, WebRTC datachannel transport, Nostr signaling (NIP-44 v2 + NIP-59 gift wrap), endpoint bytes, service-port datagrams, and browser endpoint helpers.
